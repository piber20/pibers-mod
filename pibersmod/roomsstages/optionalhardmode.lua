PibersMod.MomsHeartUnlocks = {
	...
	[PlayerType.PLAYER_JUDAS] = Achievement.SHADOW_BABY,
	[PlayerType.PLAYER_BLUEBABY] = Achievement.DEAD_BABY,
	[PlayerType.PLAYER_EVE] = Achievement.CROW_BABY,
	[PlayerType.PLAYER_SAMSON] = Achievement.FIGHTING_BABY,
	[PlayerType.PLAYER_AZAZEL] = Achievement.BEGOTTEN_BABY,
	[PlayerType.PLAYER_LAZARUS] = {Achievement.WRAPPED_BABY, Achievement.BETHANY},
	[PlayerType.PLAYER_EDEN] = Achievement.GLITCH_BABY,
	[PlayerType.PLAYER_THELOST] = Achievement.O_BABY,
	[PlayerType.PLAYER_LAZARUS2] = Achievement.WRAPPED_BABY,
	[PlayerType.PLAYER_BLACKJUDAS] = Achievement.SHADOW_BABY,
	[PlayerType.PLAYER_LILITH] = Achievement.GOAT_HEAD_BABY,
	[PlayerType.PLAYER_KEEPER] = Achievement.SUPER_GREED_BABY,
	[PlayerType.PLAYER_APOLLYON] = Achievement.LOST_BABY,
	[PlayerType.PLAYER_THEFORGOTTEN] = Achievement.MARROW,
	[PlayerType.PLAYER_THESOUL] = Achievement.MARROW,
	[PlayerType.PLAYER_BETHANY] = Achievement.WISP_BABY,
	[PlayerType.PLAYER_JACOB] = Achievement.DOUBLE_BABY,
...
PibersMod.AllMarkUnlocks = {
	...
	[PlayerType.PLAYER_JUDAS] = Achievement.BELIAL_BABY,
	[PlayerType.PLAYER_BLUEBABY] = Achievement.HIVE_BABY,
	[PlayerType.PLAYER_EVE] = Achievement.WHORE_BABY,
	[PlayerType.PLAYER_SAMSON] = Achievement.REVENGE_BABY,
	[PlayerType.PLAYER_AZAZEL] = Achievement.SUCKY_BABY,
	[PlayerType.PLAYER_LAZARUS] = Achievement.DRIPPING_BABY,
	[PlayerType.PLAYER_EDEN] = Achievement.CRACKED_BABY,
	[PlayerType.PLAYER_THELOST] = Achievement.GODHEAD,
	[PlayerType.PLAYER_LAZARUS2] = Achievement.DRIPPING_BABY,
	[PlayerType.PLAYER_BLACKJUDAS] = Achievement.BELIAL_BABY,
	[PlayerType.PLAYER_LILITH] = Achievement.DARK_BABY,
	[PlayerType.PLAYER_KEEPER] = Achievement.SALE_BABY,
	[PlayerType.PLAYER_APOLLYON] = Achievement.APOLLYON_BABY,
	[PlayerType.PLAYER_THEFORGOTTEN] = Achievement.BONE_BABY,
	[PlayerType.PLAYER_THESOUL] = Achievement.BONE_BABY,
	[PlayerType.PLAYER_BETHANY] = Achievement.HOPE_BABY,
	[PlayerType.PLAYER_JACOB] = Achievement.SOLOMONS_BABY,
...
PibersMod.GreedierUnlocks = {
	...
	[PlayerType.PLAYER_JUDAS] = Achievement.EYE_OF_BELIAL,
	[PlayerType.PLAYER_BLUEBABY] = Achievement.MECONIUM,
	[PlayerType.PLAYER_EVE] = Achievement.CROW_HEART,
	[PlayerType.PLAYER_SAMSON] = Achievement.STEM_CELL,
	[PlayerType.PLAYER_AZAZEL] = Achievement.BAT_WING,
	[PlayerType.PLAYER_LAZARUS] = Achievement.PLAN_C,
	[PlayerType.PLAYER_EDEN] = Achievement.METRONOME,
	[PlayerType.PLAYER_THELOST] = Achievement.DADS_LOST_COIN,
	[PlayerType.PLAYER_LAZARUS2] = Achievement.PLAN_C,
	[PlayerType.PLAYER_BLACKJUDAS] = Achievement.EYE_OF_BELIAL,
	[PlayerType.PLAYER_LILITH] = Achievement.DUALITY,
	[PlayerType.PLAYER_KEEPER] = Achievement.EYE_OF_GREED,
	[PlayerType.PLAYER_APOLLYON] = Achievement.BLACK_RUNE,
	[PlayerType.PLAYER_THEFORGOTTEN] = Achievement.DADS_RING,
	[PlayerType.PLAYER_THESOUL] = Achievement.DADS_RING,
	[PlayerType.PLAYER_BETHANY] = Achievement.VADE_RETRO,
	[PlayerType.PLAYER_JACOB] = Achievement.GENESIS,
	[PlayerType.PLAYER_ESAU] = Achievement.GENESIS,
	[PlayerType.PLAYER_ISAAC_B] = Achievement.REVERSED_THE_STARS,
	[PlayerType.PLAYER_MAGDALENE_B] = Achievement.REVERSED_THE_LOVERS,
	[PlayerType.PLAYER_CAIN_B] = Achievement.REVERSED_WHEEL_OF_FORTUNE,
	[PlayerType.PLAYER_JUDAS_B] = Achievement.REVERSED_THE_MAGICIAN,
	[PlayerType.PLAYER_BLUEBABY_B] = Achievement.REVERSED_THE_EMPEROR,
	[PlayerType.PLAYER_EVE_B] = Achievement.REVERSED_THE_EMPRESS,
	[PlayerType.PLAYER_SAMSON_B] = Achievement.REVERSED_STRENGTH,
	[PlayerType.PLAYER_AZAZEL_B] = Achievement.REVERSED_THE_DEVIL,
	[PlayerType.PLAYER_LAZARUS_B] = Achievement.REVERSED_JUDGEMENT,
	[PlayerType.PLAYER_EDEN_B] = Achievement.REVERSED_THE_WORLD,
	[PlayerType.PLAYER_THELOST_B] = Achievement.REVERSED_THE_FOOL,
	[PlayerType.PLAYER_LILITH_B] = Achievement.REVERSED_THE_HIGH_PRIESTESS,
	[PlayerType.PLAYER_KEEPER_B] = Achievement.REVERSED_THE_HANGED_MAN,
	[PlayerType.PLAYER_APOLLYON_B] = Achievement.REVERSED_THE_TOWER,
	[PlayerType.PLAYER_THEFORGOTTEN_B] = Achievement.REVERSED_DEATH,
	[PlayerType.PLAYER_BETHANY_B] = Achievement.REVERSED_THE_HIEROPHANT,
	[PlayerType.PLAYER_JACOB_B] = Achievement.REVERSED_THE_SUN_AND_THE_MOON,
	[PlayerType.PLAYER_LAZARUS2_B] = Achievement.REVERSED_JUDGEMENT,
	[PlayerType.PLAYER_JACOB2_B] = Achievement.REVERSED_THE_SUN_AND_THE_MOON,
...
function PibersMod:OnMarkGet(completionType, playerType)
	...
	if playerType then
		...
		local completionMarks = Isaac.GetCompletionMarks(playerType)
